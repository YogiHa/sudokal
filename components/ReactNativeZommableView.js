...
class ReactNativeZoomableView extends Component {
  ...
  render() {
    ...
    const { zoomLevel, isKeyBoardUp } = this.state;
    return (
      <View
      ...
      >
        ...
        >
          <TouchableOpacity
            onPress={() => this.setState({ zoomLevel: zoomLevel + zoomStep })}
          >
          ...
          <TouchableOpacity
            onPress={() =>
              zoomLevel > zoomStep &&
              this.setState({ zoomLevel: zoomLevel - zoomStep })
            }
          >
            <View style={styles.zoomButton}>
              <Text>-</Text>
